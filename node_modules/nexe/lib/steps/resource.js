...
function resource(compiler, next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield util_1.each(globs(resourcesWithForwardSlashes, { cwd, onlyFiles: true }), (file) => __awaiter(this, void 0, void 0, function* () {
            count++;
            step.log(`Including file: ${file}`);
            yield compiler.addResource(path_1.resolve(cwd, file));
        }));
